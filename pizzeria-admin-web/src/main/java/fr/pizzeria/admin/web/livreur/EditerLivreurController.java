...
public class EditerLivreurController extends HttpServlet {
    ...
    private static final Logger LOG = Logger
            .getLogger(EditerLivreurController.class.getName());
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (id == null || id.isEmpty()) {
            ...
            this.getServletContext().getRequestDispatcher(VUE_EDITER_LIVREUR)
                    .forward(req, resp);
       } else {
            ...
            if (livreur == null) {
               ...
               this.getServletContext()
                       .getRequestDispatcher(VUE_EDITER_LIVREUR)
                        .forward(req, resp);
            }
        }
    ...
    private void sendErrorLivreurInconnue(HttpServletRequest req,
